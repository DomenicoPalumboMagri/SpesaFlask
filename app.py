...
@app.route('/')
def home():
    lista_spesa = ListaSpesa.query.all()  # Ottieni tutti gli oggetti dal database
    return render_template('index.html', lista_spesa=lista_spesa)  # Passa lista_spesa al template
